          ...
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            <h3 style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              <span style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: 32, height: 32, borderRadius: '50%', background: '#e6f4f5', color: '#5F9EA0', fontSize: 14 }}>
                <i className={`fas ${modal === 'create' ? 'fa-user-plus' : 'fa-pencil-alt'}`}></i>
              </span>
              {modal === 'create' ? 'Nueva Persona' : 'Editar Persona'}
            </h3>
          ...
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div style={{ display: 'grid', gap: 10 }}>
              <div style={{ padding: '10px 14px', background: '#edf5f5', borderRadius: 8, fontSize: 13 }}>
                ...
                <span style={{ fontSize: 16, fontWeight: 700, color: '#111827' }}>{viewPersona.ci}</span>
              </div>
              <div style={{ padding: '10px 14px', background: '#edf5f5', borderRadius: 8, fontSize: 13 }}>
                ...
                <span style={{ fontSize: 16, fontWeight: 600, color: '#111827' }}>{viewPersona.nombre} {viewPersona.apellido}</span>
              </div>
              <div style={{ padding: '10px 14px', background: '#edf5f5', borderRadius: 8, fontSize: 13 }}>
                ...
                <span style={{ fontSize: 15, color: '#111827' }}>{mapValue('sexo', viewPersona.sexo)}</span>
              </div>
              <div style={{ padding: '10px 14px', background: '#edf5f5', borderRadius: 8, fontSize: 13 }}>
                ...
                <span style={{ fontSize: 15, color: '#111827' }}>{viewPersona.telefono || '-'}</span>
              </div>
              <div style={{ padding: '10px 14px', background: '#edf5f5', borderRadius: 8, fontSize: 13 }}>
                ...
                <span style={{ fontSize: 15, color: '#111827' }}>{viewPersona.correo || '-'}</span>
              </div>
            </div>
            <div className="modal-actions">
